...
\begin{itemize}
    ...
    \item Gây nhiễu liên tục ngăn cản việc máy phát truy cập vào kênh truyền, dẫn đến một cuộc tấn công từ chối dịch vụ (DOS).
\end{itemize}
...
\subsection{Đánh giá hiệu quả của một cuộc tấn công gây nhiễu.}
Chúng ta xác định hai chỉ số để đánh giá hiệu quả của một cuộc tấn công gây nhiễu:
\begin{itemize}
    \item PSR: đại diện cho tỉ lệ giữa gói tin thực sự được gửi thành công bởi máy phát và số gói tin mà máy phát dự định gửi.
