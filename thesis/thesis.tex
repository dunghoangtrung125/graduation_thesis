...
\begin{align*}
    r(s,a) &= \begin{cases}
        d_t, & \text{Không hoạt động,} \\
        d_n^J, & \text{Truyền dữ liệu chủ động,} \\
        d_m^r, & \text{Thu hoạch năng lượng từ sóng nhiễu,} \\
...
của hệ thống. Công thức hàm tối ưu hoá được xác định như sau:

% \begin{align*}
%     \max R(\pi) &= \lim_{T\to\infty} \frac{1}{T} \sum_{k=1}^T \mathbb{E}[r_k(s_k, \pi(s_k))]
% \end{align*}
